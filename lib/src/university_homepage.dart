...
class UniversityHomepage extends StatefulWidget {
  const UniversityHomepage({this.university});

  final String? university;

  @override
  _UniversityHomepageState createState() => _UniversityHomepageState();
}
      ...
      navigationBar: CupertinoNavigationBar(
        middle: Padding(
          ...
          child: Text(widget.university == null
              ? "Mode universitaire"
              : "Mode universitaire ${_universityName != null ? _universityName : ""}"),
        ),
      ),
      child: SafeArea(
        child: Padding(
              ...
              if (snapshotUniversities.connectionState ==
                ...
                if (snapshotUniversities.data != null &&
                  ...
                  Future.delayed(
                      Duration.zero,
                      () => setState(() {
                            _universityName = (document.data() as Map)["name"];
                          }));

                  _productsSelected =
                      List<String>.from((document.data() as Map)["products"]);
                        ...
                        children: [
                          ...
                          widget.university == null
                              ? Wrap(
                                  spacing: 10,
                                  runSpacing: 8,
                                  children: snapshotUniversities.data?.docs
                                          .map((university) {
                                        Map universityMap =
                                        ...
                                        return CupertinoButton(
                                          ...
                                          color: _university == university.id
                            ...
                            builder: (context, snapshotProducts) {
                              if (snapshotProducts.connectionState ==
                                ...
                                return Column(children: [
                                  ...
                                  ...snapshotProducts.data?.docs.map((product) {
                          ...
                          onPressed: !_isInitial
                              ? () {
                                  ...
                                  if (Navigator.of(context).canPop()) {
                                    ...
                                    _initialSelection =
                                        List<String>.from(_productsSelected);
                                  }
                                }
                              : null),
                    )
